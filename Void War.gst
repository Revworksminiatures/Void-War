  ...
  <profileTypes>
    ...
    <profileType id="4487-44d7-2322-d781" name="Starship">
      <characteristicTypes>
        ...
        <characteristicType id="ad3b-8b26-47ba-c073" name="WS"/>
        <characteristicType id="1983-3f45-9951-7db0" name="DS"/>
        <characteristicType id="eeb4-9519-cdeb-e0ed" name="MAN"/>
        <characteristicType id="71b6-3c7f-c8e4-3322" name="SI"/>
        <characteristicType id="8a50-4f93-4b23-7ee6" name="CC"/>
        <characteristicType id="74ff-b92c-d121-74ee" name="ARM"/>
        <characteristicType id="667a-c155-ab8b-e83f" name="PR"/>
        <characteristicType id="480f-fee3-9b40-433c" name="CM"/>
        <characteristicType id="872a-ccc5-1cd8-391c" name="PROP"/>
        ...
        <selectionEntry id="ed3f-9b1f-80cd-9579" name="1 Command Point Cards" hidden="false" collective="false" import="true" type="upgrade">
          ...
          <selectionEntries>
            <selectionEntry id="9750-6f0d-2640-3df2" name="•Ahead Full!" publicationId="33f2-a17a-6c67-dfa5" hidden="false" collective="false" import="true" type="upgrade">
              <constraints>
                <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="293d-9581-18c8-8480" type="max"/>
              </constraints>
              <rules>
            ...
            <selectionEntry id="880a-7b27-c57b-1988" name="•Concentrated Barrage" publicationId="33f2-a17a-6c67-dfa5" hidden="false" collective="false" import="true" type="unit">
              <constraints>
                <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="ee3e-0203-2f7a-0b0c" type="max"/>
              </constraints>
              <rules>
